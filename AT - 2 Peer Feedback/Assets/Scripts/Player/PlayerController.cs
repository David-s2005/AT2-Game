...
public class PlayerController : MonoBehaviour
{
    ...
    // getter for default movement speed. David wus here.
    ...
    // Setter for default current speed.
    public void setCurrentMovementSpeed(float value)
    {
        currentMovementSpeed = defaultSpeed + value;
    }
